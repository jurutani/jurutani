...
<template>
  <div v-if="!isRedirecting" class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
    <div class="max-w-md w-full space-y-8 p-8">
      <div class="text-center">
        ...
        <div v-else-if="error" class="space-y-4">
          ...
          <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Login Gagal</h2>
          <p class="text-red-600 dark:text-red-400">{{ error }}</p>
          <p class="text-sm text-gray-500 dark:text-gray-400">Anda akan diarahkan kembali ke halaman login...</p>
        </div>
        ...
        <div v-else-if="success" class="space-y-4">
          ...
          <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Login Berhasil</h2>
          <p class="text-gray-500 dark:text-gray-400">Mengalihkan ke Juru Tani...</p>
        </div>
      </div>
    </div>
  </div>
