...
<template>
  <main class="announcement-page container mx-auto px-4 py-12">
    ...
    <header class="mx-auto mb-6 max-w-4xl text-center">
      ...
      <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-emerald-700 via-teal-600 to-cyan-600 bg-clip-text text-transparent py-2">
