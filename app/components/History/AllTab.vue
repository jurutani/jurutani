...
<template>
  <div>
    ...
    <div v-else-if="!historyItems || historyItems.length === 0" class="text-center py-16">
      <UIcon name="heroicons:document-text" class="w-16 h-16 text-gray-400 dark:text-gray-600 mx-auto mb-4" />
        ...
        <div class="p-6">
          <div class="flex items-start justify-between mb-4">
            ...
            <div class="flex items-center space-x-3">
              ...
              >
                <UIcon :name="item.type === 'news' ? 'heroicons:newspaper' : 'heroicons:shopping-cart'" class="w-4 h-4 mr-1" />
                {{ item.typeLabel }}
              </span>
