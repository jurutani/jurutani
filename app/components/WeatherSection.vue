      ...
      <div class="flex justify-center mb-6">
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-1 shadow-lg">
          <nav class="flex space-x-1">
            ...
            >
              <Icon name="i-ic-baseline-wb-sunny" class="w-4 h-4 mr-2 inline-block" />
              Cuaca Saat Ini
            </button>
            <button
              :class="[
            ...
            >
              <Icon name="i-ic-baseline-access-time" class="w-4 h-4 mr-2 inline-block" />
              Ramalan 24 Jam
            </button>
            <button
              :class="[
            ...
            >
              <Icon name="i-ic-baseline-date-range" class="w-4 h-4 mr-2 inline-block" />
              Ramalan 5 Hari
            </button>
          </nav>
        </div>
          ...
          <div v-else-if="weatherData" class="space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-lg">
                <div class="flex items-center mb-2">
                  <Icon name="i-ic-baseline-water-drop" class="w-6 h-6 text-green-500 mr-2" />
              ...
              <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-lg">
                <div class="flex items-center mb-2">
                  <Icon name="i-ic-baseline-air" class="w-6 h-6 text-green-500 mr-2" />
              ...
              <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-lg">
                <div class="flex items-center mb-2">
                  <Icon name="i-ic-baseline-wb-sunny" class="w-6 h-6 text-orange-500 mr-2" />
              ...
              <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-lg">
                <div class="flex items-center mb-2">
                  <Icon name="i-ic-baseline-wb-twilight" class="w-6 h-6 text-red-500 mr-2" />
              ...
              <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-lg">
                <div class="flex items-center mb-2">
                  <Icon name="i-ic-baseline-visibility" class="w-6 h-6 text-purple-500 mr-2" />
              ...
              <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-lg">
                <div class="flex items-center mb-2">
                  <Icon name="i-ic-baseline-speed" class="w-6 h-6 text-indigo-500 mr-2" />
            ...
            <div v-if="farmingConditions" class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
              <h3 class="text-xl font-bold mb-4 flex items-center dark:text-white">
                <Icon name="i-ic-baseline-agriculture" class="w-6 h-6 mr-2 text-green-500" />
                Rekomendasi Pertanian
              </h3>
              ...
              <div class="space-y-3">
                ...
                >
                  <Icon name="i-ic-baseline-info" class="w-5 h-5 mr-3 text-green-500 flex-shrink-0 mt-0.5" />
